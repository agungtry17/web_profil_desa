...
<div class="bg-white p-6 rounded shadow max-w-lg">
    <form action="{{ route('admin.perangkat.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
        @csrf
        ...
        <div>
            ...
            <input type="text" name="jabatan" value="{{ old('jabatan') }}" placeholder="misal: Kepala Desa" class="w-full border rounded px-3 py-2">
        ...
        <div>
            ...
            <input type="number" name="urutan" value="{{ old('urutan', 0) }}" class="w-full border rounded px-3 py-2">
        </div>
